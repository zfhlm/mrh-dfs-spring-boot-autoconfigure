...
public class FileStoreAutoConfiguration{
	...
	private static final String FASTDFS_PREFIX = "dfs.fastdfs";

	private static final String DISK_PREFIX = "dfs.disk";

	private static final String COS_PREFIX = "dfs.cos";

	private static final String FTP_PREFIX = "dfs.ftp";
